...
describe('VueSimplePicker', function () {
    it('存在', function () {
        expect(_VueSimplePicker2.default).to.be.ok;
    });
    it('data参数正常', function () {
        var Constructor = _vue2.default.extend(_VueSimplePicker2.default);
        ...
        var el = vm.$el.querySelector('li');
        expect(el.innerText).to.equal('2016');
    });
    it('change事件执行', function () {
        var Constructor = _vue2.default.extend(_VueSimplePicker2.default);
        var data = [{
            default: 0,
            values: [2016, 2017, 2018]
...
},{"vue":4,"../src/VueSimplePicker.vue":3}]},{},[1], null)
//# sourceMappingURL=/VueSimplePicker.test.map